...
public final class DeviceControlActivity extends BaseActivity {
    ...
    private TextView data_log_roll;
    private TextView data_log_pitch;
    private TextView data_log_yaw;

    // Настройки приложения
    private boolean hexMode, checkSum, needClean;
    private boolean show_timings, show_direction;
    private String command_ending;
    //private String commandValueToTextVeiw;
...
// See https://g.co/AppIndexing/AndroidStudio for more information.
        ...
        //擷取指令內部資料分析
        this.commandValueToTextVeiw = getCommandValueToTextVeiw();
    ...
    public getCommandValueToTextVeiw() {
        TextView data_log_roll = (TextView) findViewById(R.id.data_log_roll)
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("DeviceControl Page") // TODO: Define a title for the content shown.
